...
public class MeshDestroy : MonoBehaviour
{
    ...
    public HutDestroyHandler hutDestroyHandler;
    ...
    public class PartMesh
    {
        ...
        {
            original.gameObject.GetComponent<Outline>().enabled = false;
            ...
            MeshRenderer org = original.GetComponent<MeshRenderer>();
          
            
            foreach (var material in org.materials)
            {
            ...
            renderer.materials = org.materials;
           
     

          
            
            original.hutDestroyHandler.AddMaterialsToList(renderer.material);
